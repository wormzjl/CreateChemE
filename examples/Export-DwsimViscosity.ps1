...
& $exe $Dwsim $characterizationPath (Join-Path $repo 'src/main/resources/data/createcheme/materials/properties') (Join-Path $repo 'build/dwsim-viscosity-export.json')
