...
- Archive dry-run passed: `git apply --check --ignore-space-change benchmarks/archives/v3-recovery-experiment.patch`. The patch SHA-256 is `9a410d69791cc43f16c8ad5fae543b39ae043c54e823a4fbe85cd33001cb5667`. Applying it would restore the experiment, so it is not applied in the production tree.
...
- Rebuilt `build/libs/createcheme-0.1.0.jar`: **638684 bytes**, SHA-256 `6152c2121a205341c263e66f600d881f9a804707678ef3414fd19ce8bdfd6b1f`, exactly matching the pre-experiment artifact documented in `V3_PRECISION_FLASH_TRUNCATION_RESULTS.md`.
