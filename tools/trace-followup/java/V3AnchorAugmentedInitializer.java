...
/** Offline absolute-output Transformer with optional full or compact native anchor inputs. Parser-owned weights are immutable after validation.
 * Every prediction owns all scratch arrays; cooperative cancellation is checked inside matrix work.
 */
final class V3AnchorAugmentedInitializer implements V3NeuralInitializer {
    ...
    private V3AnchorAugmentedInitializer(Document model) { this.model = model; }

    static V3AnchorAugmentedInitializer read(InputStream stream) throws IOException {
        ...
        var result = new V3AnchorAugmentedInitializer(m);
