 ...
 */
public final class V3CapacityEvaluationProbe {
    static final String REVISION = "capacity-column-evaluation-v1";
    ...
    private V3CapacityEvaluationProbe() {}
    ...
    public static void main(String[] args) throws Exception {
        ...
        V3NeuralInitializer model = V3CapacityModels.read(modelPath);
