# Original TJL19 neural initializer MVP (historical)

These notes describe the first 19-component temperature-slice experiment. See [README.md](README.md) for
the current methane dry/wet bundle. Original weights and the model card remain unchanged for reproduction.
...
At the [methane-property qualification milestone](methane-qualification.md), fresh calculators switched
to TJL20. This original model declines that package; the later methane bundle supplies its own predictors.
