 ...
 */
public final class V3ConcurrentColumnEvaluationProbe {
    static final String REVISION = "concurrent-column-evaluation-v1";
    ...
    private V3ConcurrentColumnEvaluationProbe() {}

    public static void main(String[] args) throws Exception {
        if (args.length != 7) throw new IllegalArgumentException("directory input-jsonl model workers deadline-seconds neural-budget-ms iterations");
        ...
        metadata.put("modelParameterStorageBytes", V3CandidateModels.parameterStorageBytes(model));
        ...
        var warmup = V3NeuralMvpProbe.input(JsonParser.parseString(Files.readString(Path.of("tools/neural/methane-qualification.json")))
    ...
    private static Map<String, Object> evaluate(JsonObject source, V3NeuralInitializer model,
        ...
        try { raw = model.predict(input, deadline(start, deadlineMillis)).orElse(null); }
        ...
        if (raw != null) prediction.put("nativeResidual", residual(raw));
