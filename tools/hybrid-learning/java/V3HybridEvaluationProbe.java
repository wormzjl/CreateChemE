 ...
 */
public final class V3HybridEvaluationProbe {
    static final String REVISION = "hybrid-column-evaluation-v1";
    ...
    private V3HybridEvaluationProbe() {}
    ...
    public static void main(String[] args) throws Exception {
        ...
        V3NeuralInitializer model = V3HybridModels.read(modelPath);
