"""Locked ten-worker validation of every decoder variant, in two reversed-order blocks."""
from floor_common import *
from floor_native import execute
from floor_register import verify_plan
...
def validate_run(directory, name):
    ...
    assert meta['revision'] == 'decoder-floor-column-evaluation-v1'
    ...
    assert meta['pipelineManifest']['decoder'] == PIPELINES[name]
...
def invoke(name, block):
    ...
    execute('V3FloorEvaluationProbe',
