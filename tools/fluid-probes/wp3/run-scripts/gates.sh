#!/usr/bin/env bash
# WP3 gates, one Gradle invocation at a time, logs in wp3-logs/final-gate-*.log.
cd "D:/Minecraft/Modding/1.21/CreateChemE/.claude/worktrees/agent-ae139e4fc1b184b36" || exit 2
L=documentation/fluid-scheduler/wp3-logs
...
G gametest runFluidGameTestServer -PfluidGameTestRunId=wp3-final-r01
