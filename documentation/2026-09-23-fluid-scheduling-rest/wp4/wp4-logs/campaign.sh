#!/usr/bin/env bash
# WP4 benchmark campaign (60 s warm-up, 60 s window), one run at a time. Before every run: no Endfield.exe and at least 20 GB of free
...
LOGS=documentation/fluid-scheduler/wp4-logs
