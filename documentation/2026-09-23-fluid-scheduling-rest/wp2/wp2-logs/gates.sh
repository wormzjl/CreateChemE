#!/usr/bin/env bash
# WP2 gates, one Gradle invocation at a time, logs in wp2-logs/final-gate-*.log.
cd "D:/Minecraft/Modding/1.21/CreateChemE/.claude/worktrees/agent-ae139e4fc1b184b36" || exit 2
L=documentation/fluid-scheduler/wp2-logs
...
G gametest runFluidGameTestServer -PfluidGameTestRunId=wp2-final-r01
