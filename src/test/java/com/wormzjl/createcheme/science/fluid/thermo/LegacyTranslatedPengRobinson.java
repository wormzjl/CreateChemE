...
/**
 * The {@code TranslatedPengRobinson} implementation as it stood at {@code 7d26793}, kept as a test-only
 * oracle for the WP6a rewrite onto the shared {@code PengRobinsonKernel}.
 *
 * <p>It is a verbatim copy: the dense {@code TemperatureTerms} with its three n x n matrices, the classical
 * quadratic mixing read out of them, {@code PengRobinson78.compressibilityRoot} for Z, and the same
 * volumetric and caloric algebra. {@link TranslatedPengRobinsonOracleTest} holds every field of every
 * {@code Phase} against it. The only edit is the removal of the {@code SolverDiagnostics} counter, which
 * would have made the oracle contribute to the production counters.</p>
 */
final class LegacyTranslatedPengRobinson {
    ...
    LegacyTranslatedPengRobinson(List<ThermoComponent> components, double[][] interactions,
    ...
    TranslatedPengRobinson.Phase evaluate(double temperature, double pressure, double[] amounts, PhaseRoot root) {
    ...
    static final class TemperatureTerms {
        private final LegacyTranslatedPengRobinson owner;
        private final double temperature;
        private final double[][] a,first,second;
        private final double[] heatCapacity,enthalpy;
        private TemperatureTerms(LegacyTranslatedPengRobinson owner,double temperature,double[][] a,double[][] first,double[][] second,double[] cp,double[] h) {
    ...
    TemperatureTerms temperatureTerms(double temperature) {
    ...
    TranslatedPengRobinson.Phase evaluate(double temperature,double pressure,double[] amounts,PhaseRoot root,TemperatureTerms terms) {
        ...
        return new TranslatedPengRobinson.Phase(physicalV, h, h-pressure*physicalV, dvdt, dvdp, cp, dhdp,
