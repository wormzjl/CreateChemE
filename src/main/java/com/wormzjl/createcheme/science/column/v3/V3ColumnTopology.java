...
public final class V3ColumnTopology {
    ...
    public static V3ColumnTopology liquidOnly(int trayCount, int feedTrayNumber) {
    ...
    public boolean hasVaporPhase(int node) {
        requireNode(node);
        return node != condenserNode() || condenserPhaseBranch != V3CondenserPhaseBranch.LIQUID_ONLY;
    }
