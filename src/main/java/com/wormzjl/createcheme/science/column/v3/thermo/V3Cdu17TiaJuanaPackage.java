...
final class V3Cdu17TiaJuanaPackage implements V3PropertyPackage {
    ...
    private static final List<V3PropertyComponent> COMPONENTS = List.of(
            descriptor("methane", "Methane", 0.016043, 111.66, 190.564, 4_599_200, 0.01142, 356.07, 35.69, 0.050, 0.0, false, true),
            descriptor("ethane", "Ethane", 0.030070, 184.55, 305.32, 4_872_000, 0.0995, 356.073, 52.49, 0.120, 0.0, false, true),
            descriptor("propane", "Propane", 0.044097, 231.05, 369.83, 4_248_000, 0.1523, 506.881, 73.60, 0.165, 0.0, false, true),
            descriptor("C4_CDU", "C4 CDU lump", 0.0581222, 269.59, 424.10, 3_800_000, 0.2000, 578.583, 96.00, 0.210, 0.0, false, true),
            descriptor("PC01", "PC01", 0.0860, 315.82, 492.55999480578146, 4_178_434.84448104, 0.22608738401077633, pseudocomponentDensity(728.921), 112.0, 0.245, 0.0, false, true),
            descriptor("PC02", "PC02", 0.1010, 345.55, 527.8025186583332, 3_751_314.491605433, 0.26472342901494617, pseudocomponentDensity(749.0), 126.0, 0.270, 0.0, false, true),
            descriptor("PC03", "PC03", 0.1230, 383.49, 569.3692139045123, 3_246_675.3539700373, 0.3244879676576933, pseudocomponentDensity(769.0), 145.0, 0.295, 0.0, false, true),
            descriptor("PC04", "PC04", 0.1450, 419.35, 607.073597206833, 2_864_575.194282997, 0.38669548789930985, pseudocomponentDensity(789.0), 164.0, 0.320, 0.0, false, true),
            descriptor("PC05", "PC05", 0.1740, 456.08, 644.2216792479735, 2_534_536.7251496073, 0.4553983265416594, pseudocomponentDensity(809.0), 187.0, 0.345, 0.0, false, true),
            descriptor("PC06", "PC06", 0.2050, 504.50, 689.6851072684117, 2_132_757.407375936, 0.557980993981746, pseudocomponentDensity(829.0), 215.0, 0.370, 0.0, false, true),
            descriptor("PC07", "PC07", 0.2440, 553.53, 734.3987838516796, 1_810_605.5611405328, 0.6678184664239446, pseudocomponentDensity(850.0), 249.0, 0.395, 0.0, false, true),
            descriptor("PC08", "PC08", 0.2860, 602.38, 777.8713772906234, 1_549_949.2600690369, 0.7824175712678637, pseudocomponentDensity(871.0), 286.0, 0.420, 0.0, false, true),
            descriptor("PC09", "PC09", 0.3330, 650.99, 820.377320000774, 1_336_780.4757975033, 0.9004393215980728, pseudocomponentDensity(892.0), 328.0, 0.445, 0.0, false, true),
            descriptor("PC10", "PC10", 0.3820, 709.04, 869.1971815576578, 1_114_480.0231325733, 1.039341380087733, pseudocomponentDensity(914.0), 374.0, 0.470, 0.0, false, true),
            descriptor("PC11", "PC11", 0.4700, 823.04, 964.0847894556182, 797_049.0014191915, 1.2856950852172864, pseudocomponentDensity(958.974), 455.0, 0.500, 0.0, false, true),
            new V3PropertyComponent("PC12", "PC12 residue surrogate", PC12_MOLECULAR_WEIGHT_KG_PER_MOL,
                    ...
                    -0.002591126843297, 9.048103532950e-7, true, false));
    ...
    public List<String> advisoryEvidence() {
        return List.of("ESTIMATED_HEAVY_RESIDUE: PC12 is extrapolated and vapor-ineligible");
    }
    ...
    private static V3PropertyComponent descriptor(
            ...
            double cpA, double cpB, double cpC, boolean residue, boolean vaporEligible) {
        return new V3PropertyComponent(
                id, label, mw, nbp, tc, pc, omega, density, cpA, cpB, cpC, 0.0, residue, vaporEligible);
    }
